...
public class BookService {
  ...
  public BookResponse createBook(
      BookRequest request, List<Category> categoryList, List<MultipartFile> imageList) {
  ...
  public BookResponse updateBook(
      Long id, BookRequest request, List<Category> categoryList, List<MultipartFile> imageList) {
    Book book =
        bookRepository
            .findById(id)
            .orElseThrow(() -> new CustomException(BookErrorCode.BOOK_NOT_FOUND));
